...
let livres = [
    { id: 1, titre: "Les Misérables", auteurId: 1, categorieId: 1 },
    { id: 2, titre: "Harry Potter", auteurId: 2, categorieId: 2 }
];
let counterLivres = 3;
...
function addLivre() {
    ...
    livres.push({ id: counterLivres++, titre, auteurId, categorieId });
    clearLivreForm();
    refreshAll();
}
